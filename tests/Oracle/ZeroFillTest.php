...
/**
 * Test case for Oracle bitwise zero fill (>>>) operator.
 *
 * @author Jury Sosnovsky <github@sosnoffsky.com>
 */
class ZeroFillTest extends OracleTestCase
{
    /**
    ...
    public function testSelect()
    {
        $this->assertDqlWithGeneratedSql(
            'SELECT ZEROFILL(2, 3) from DoctrineBinary\Tests\Entities\BlankTest b',
    ...
    {
        $this->assertDqlWithGeneratedSql(
            'SELECT b from DoctrineBinary\Tests\Entities\BlankTest b WHERE ZEROFILL(b.id, 3) = 16',
    ...
    {
        $this->assertDqlWithGeneratedSql(
            'SELECT b from DoctrineBinary\Tests\Entities\BlankTest b WHERE ZEROFILL(b.id, :value) = :bitesize',
