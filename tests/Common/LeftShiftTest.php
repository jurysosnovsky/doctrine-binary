...
/**
 * Test case for common bitwise left shift (<<) operator.
 *
 * @author Jury Sosnovsky <github@sosnoffsky.com>
 */
class LeftShiftTest extends CommonTestCase
{
    /**
    ...
    public function testSelect()
    {
        $this->assertDqlWithGeneratedSql(
            'SELECT LSHIFT(2, 3) from DoctrineBinary\Tests\Entities\BlankTest b',
    ...
    {
        $this->assertDqlWithGeneratedSql(
            'SELECT b from DoctrineBinary\Tests\Entities\BlankTest b WHERE LSHIFT(b.id, 3) = 16',
    ...
    {
        $this->assertDqlWithGeneratedSql(
            'SELECT b from DoctrineBinary\Tests\Entities\BlankTest b WHERE LSHIFT(b.id, :value) = :bitesize',
