...
/**
 * Test case for common bitwise right shift (>>) operator.
 *
 * @author Jury Sosnovsky <github@sosnoffsky.com>
 */
class RightShiftTest extends CommonTestCase
{
    /**
    ...
    public function testSelect()
    {
        $this->assertDqlWithGeneratedSql(
            'SELECT RSHIFT(2, 3) from DoctrineBinary\Tests\Entities\BlankTest b',
    ...
    {
        $this->assertDqlWithGeneratedSql(
            'SELECT b from DoctrineBinary\Tests\Entities\BlankTest b WHERE RSHIFT(b.id, 3) = 16',
    ...
    {
        $this->assertDqlWithGeneratedSql(
            'SELECT b from DoctrineBinary\Tests\Entities\BlankTest b WHERE RSHIFT(b.id, :value) = :bitesize',
