...
class BitXorTest extends MysqlTestCase
{
    ...
    public function testSelect()
    {
        $this->assertDqlWithGeneratedSql(
            'SELECT BIT_XOR(b.id) from DoctrineBinary\Tests\Entities\BlankTest b GROUP BY b.type',
            'SELECT BIT_XOR(b0_.id) AS sclr_0 FROM BlankTest b0_ GROUP BY b0_.type'
        );
    }
}
