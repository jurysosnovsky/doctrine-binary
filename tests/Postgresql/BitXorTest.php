...
namespace DoctrineBinary\Tests\Postgresql;

use DoctrineBinary\Tests\PostgresqlTestCase;

/**
 * Test case for PostgreSQL bitwise XOR (#) operator.
 *
 * @author Jury Sosnovsky <github@sosnoffsky.com>
 */
class BitXorTest extends PostgresqlTestCase
{
    /**
